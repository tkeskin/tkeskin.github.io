...
var documents = [{
    ...
    "title": "Anasayfa",
    "body": "      Öne çıkan:                                                                                                                                                                                                                       Mülakat Soruları                              :                Android –&gt; EnYakinOtel Android –&gt; CountriesInfo:                                                                       29 Jun 2019                &lt;/span&gt;                                                                                                                                                                                                                                                                                                        Hackerrank                              :               Soruları ve Cevapları:                                                                       26 Jun 2019                &lt;/span&gt;                                                                                                                                                                              Tüm Hikayeler:                                                             Quarkus Nedir Helidon Nedir              :        Alternatif server framework arayışı içinde olanlara güzel bir karşılaştırma –&gt; Quarkus ve Oracle Helidon –&gt; Java Libraries for Writing Microservices:                               25 Aug 2019        &lt;/span&gt;                                                                                    GraphQL nedir GraphQL vs Rest              :        Uzun bir aradan sonra (Mac beta update sağolsun jekkly problemleri ile uğraştırdı); GraphQL hakkında güzel bir sunum –&gt; https://youtu. be/SXaqNuY9mYo:                               25 Aug 2019        &lt;/span&gt;                                                                                    Mülakat Soruları              :        Android –&gt; EnYakinOtel Android –&gt; CountriesInfo:                               29 Jun 2019        &lt;/span&gt;                                                                                    Yaml nedir ?              :       YAML dil bağımsız bir veri değişim formatıdır. Herhangi bir programlama dili ile oluşturulan nesneler, YAML formatında kolaylıkla temsil edilebilmektedir. YAML geniş veri tipi desteği sayesinde tüm diller arasında ortak olarak. . . :                               27 Jun 2019        &lt;/span&gt;                                                                                    Hackerrank              :       Soruları ve Cevapları:                               26 Jun 2019        &lt;/span&gt;                                       &laquo; Geri       1        2        3      İleri &raquo; "
    }, {
    "id": 3,
    ...
    "id": 6,
    "url": "http://localhost:4000/quarkus-nedir-helidon-nedir/",
    "title": "Quarkus Nedir Helidon Nedir",
    "body": "2019/08/25 -  Alternatif server framework arayışı içinde olanlara güzel bir karşılaştırma –&gt; Quarkus ve Oracle Helidon –&gt; Java Libraries for Writing Microservices"
    }, {
    "id": 7,
    "url": "http://localhost:4000/graphql-nedir-graphql-vs-rest/",
    "title": "GraphQL nedir GraphQL vs Rest",
    "body": "2019/08/25 -  Uzun bir aradan sonra (Mac beta update sağolsun jekkly problemleri ile uğraştırdı); GraphQL hakkında güzel bir sunum –&gt; https://youtu. be/SXaqNuY9mYo"
    }, {
    "id": 8,
